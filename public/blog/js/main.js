...
function manejarNuevaEntrada() {
  ...
  const nuevoBorrador = crearEntrada(datosDelFormulario.titulo, datosDelFormulario.contenido, datosDelFormulario.etiquetas, datosDelFormulario.imagenes);
...
document.addEventListener('astro:page-load', iniciarAplicacion);
